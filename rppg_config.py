...
class RPPGConfig:
    ...
    HARMONIC_PROXIMITY_TOL: float = 8.0
    TEMPORAL_INERTIA_ALPHA: float = 0.3
    MAX_BPM_JUMP: float = 15.0
    ...
    ROI_CONSENSUS_THRESHOLD: float = 25.0
    ...
    BPM_EMA_ALPHA_RESEARCH: float = 0.15
    BAD_FREQS_BPM: list = (150.0, 120.0)
    PEAK_PROMINENCE_MIN: float = 0.3
    CONSENSUS_STD_MAX: float = 15.0
    PEAK_DOMINANCE_RATIO_MIN: float = 1.5
